...
S.mixin=function(e){C(S.functions(e),function(t){var n=S[t]=e[t];S.prototype[t]=function(){var e=[this._wrapped];return s.apply(e,arguments),L.call(this,n.apply(S,e))}})};// Generate a unique integer id (unique within the entire client session).
...
var i=new RegExp([(n.escape||R).source,(n.interpolate||R).source,(n.evaluate||R).source].join("|")+"|$","g"),o=0,s="__p+='";e.replace(i,function(t,n,r,i,a){return s+=e.slice(o,a).replace(H,function(e){return"\\"+I[e]}),n&&(s+="'+\n((__t=("+n+"))==null?'':_.escape(__t))+\n'"),r&&(s+="'+\n((__t=("+r+"))==null?'':__t)+\n'"),i&&(s+="';\n"+i+"\n__p+='"),o=a+t.length,t}),s+="';\n",// If a variable is not specified, place data values in local scope.
...
var L=function(e){return this._chain?S(e).chain():e};// Add all of the Underscore functions to the wrapper object.
S.mixin(S),// Add all mutator Array functions to the wrapper.
C(["pop","push","reverse","shift","sort","splice","unshift"],function(e){var t=r[e];S.prototype[e]=function(){var n=this._wrapped;return t.apply(n,arguments),"shift"!=e&&"splice"!=e||0!==n.length||delete n[0],L.call(this,n)}}),// Add all accessor Array functions to the wrapper.
C(["concat","join","slice"],function(e){var t=r[e];S.prototype[e]=function(){return L.call(this,t.apply(this._wrapped,arguments))}}),S.extend(S.prototype,{// Start chaining a wrapped Underscore object.
...
// that will be called.
url:function(){var e=n.result(this,"urlRoot")||n.result(this.collection,"url")||I();return this.isNew()?e:e.replace(/([^\/])$/,"$1/")+encodeURIComponent(this.id)},// **parse** converts a response into the hash of attributes to be `set` on
...
i.url||(s.url=n.result(r,"url")||I()),// Ensure that we have the appropriate request data.
...
switch(s){case 8:case 9:case 10:case 12:case 13:case 34:case 92:n+=T[s];break;default:if(32>s){n+=N+E(2,s.toString(16));break}n+=o?t[r]:b?e.charAt(r):e[r]}}return n+'"'},j=function(e,t,n,r,c,u,l){var f,p,h,b,x,S,C,T,A,N,_,B,O,q,R,I;try{// Necessary for host object support.
...
// `JSON.stringify`.
_.push(P(e)+":"+(c?" ":"")+t)}),I=_.length?c?"{\n"+u+_.join(",\n"+u)+"\n"+R+"}":"{"+_.join(",")+"}":"{}";// Remove the object from the traversed object stack.
return l.pop(),I}};// Public: `JSON.stringify`. See ES 5.1 section 15.12.3.
...
if(!n("json-parse")){var _,B,O=String.fromCharCode,q={92:"\\",34:'"',47:"/",98:"\b",116:"	",110:"\n",102:"\f",114:"\r"},R=function(){throw _=B=null,SyntaxError()},I=function(){for(var e,t,n,r,i,o=B,s=o.length;s>_;)switch(i=o.charCodeAt(_)){case 9:case 10:case 13:case 32:// Skip whitespace tokens, including tabs, carriage returns, line
...
t=[];e=I(),"]"!=e;n||(n=!0))// If the array literal contains elements, the current token
// should be a comma separating the previous element from the
// next.
n&&(","==e?(e=I(),"]"==e&&// Unexpected trailing `,` in array literal.
...
t={};e=I(),"}"!=e;n||(n=!0))// If the object literal contains members, the current token
// should be a comma separator.
n&&(","==e?(e=I(),"}"==e&&// Unexpected trailing `,` in object literal.
R()):// A `,` must separate each object member.
R()),// Leading commas are not permitted, object property names must be
// double-quoted strings, and a `:` must separate each property
// name and value.
(","==e||"string"!=typeof e||"@"!=(b?e.charAt(0):e[0])||":"!=I())&&R(),t[e.slice(1)]=H(I());return t}// Unexpected token encountered.
R()}return e},L=function(e,t,n){var r=D(e,t,n);r===s?delete e[t]:e[t]=r},D=function(e,t,n){var r,i=e[t];if("object"==typeof i&&i)// `forEach` can't be used to traverse an array in Opera <= 8.54
// because its `Object#hasOwnProperty` implementation returns `false`
// for array indices (e.g., `![1, 2, 3].hasOwnProperty("0")`).
if(a.call(i)==y)for(r=i.length;r--;)L(i,r,n);else o(i,function(e){L(i,e,n)});return n.call(e,t,i)};// Public: `JSON.parse`. See ES 5.1 section 15.12.2.
l.parse=function(e,t){var n,r;// If a JSON string contains multiple tokens, it is invalid.
// Reset the parser state.
return _=0,B=""+e,n=H(I()),"$"!=I()&&R(),_=B=null,t&&a.call(t)==h?D((r={},r[""]=n,r),"",t):n}}}// Export for asynchronous module loaders.
c&&e(function(){return l})}(this)},{}],43:[function(e,t){function n(e,t){var n=[];t=t||0;for(var r=t||0;r<e.length;r++)n[r-t]=e[r];return n}t.exports=n},{}]},{},[1])(1)}),define("js/magician",["require","jquery","velocity","underscore","js/constant","backbone","js/timer","js/token","socket-io"],function(e){function t(e){return function(){try{e.apply(this,arguments)}catch(t){throw console.error(t),t}}}function n(e,t){this.selection=t,this.el=e,this.$el=$(e),this.$avatar=this.$el.find(".magician-avatar"),this.$name=this.$el.find(".magician-name"),this.$accuracy=this.$el.find(".accuracy-percent"),this.ensureAccuracy(),this.selection.on("change:accuracy",u.bind(function(){console.log("accuracy changed:",this.selection.get("accuracy")),this.ensureAccuracy()},this)),_.on("magician-switched",u.bind(function(){console.log("MagicianView: magician changed"),this.magician=_.get("magician"),this.magician.on("start",u.bind(function(){this.showMagician()},this)),this.magician.on("score",u.bind(function(){"none"===this.$avatar.css("display")&&this.showMagician()},this)),this.magician.on("scored",u.bind(function(){"none"===this.$avatar.css("display")&&this.showMagician();var e=this.selection.get("accuracy")||0,t=this.selection.get(String(this.magician.get("id")));u.each(this.magician.get("scores"),function(n){t===l.score(n)&&e++}),this.selection.set("accuracy",e)},this))},this))}function r(e){var t="scores-"+e+"-"+h;localStorage.setItem(t,JSON.stringify(B.toJSON())),y.emit("add-score",{id:e,token:h,score:B.toJSON()})}function i(e){var t="scores-"+e+"-"+h,n=localStorage.getItem(t);return n?JSON.parse(n):{}}function o(e,t){function n(){var e=$(this);if(!e.hasClass("close")){var t=r.magician&&(r.magician.isPlaying()||r.magician.isScoring())&&!r.cardSelection.has(String(r.magician.get("id")));if(t){var n=e.data("score");e.hasClass("highlighted")?(r.$tip.html("已确定选牌"),r.cardSelection.score(r.magician.id,n)):(r.$el.find(".highlighted").removeClass("highlighted"),e.addClass("highlighted"))}}}this.cardSelection=t,this.el=e,this.$el=$(e),this.$cards=this.$el.find(".card"),this.$tip=this.$el.find(".tip");var r=this;this.ensureCards(),_.on("magician-switched",u.bind(function(){this.magician;this.magician=_.get("magician"),this.magician.once("start",u.bind(function(){this.$tip.html("双击扑克牌为选手打分"),this.ensureCards()},this)),this.magician.once("scored",u.bind(function(){this.ensureCards()},this))},this)),this.$cards.tap?this.$cards.tap(n):this.$cards.click(n),this.cardSelection.on("change",u.bind(function(){this.magician&&this.ensureCards()},this)),u.extend(this,f.Events)}function s(e){B.set(i(e.id)),B.on("change",function(){r(e.id)}),_.set("status",e.status),e.magician&&_.setMagician(new C(e.magician));var t=_.get("magician");if(t)switch(t.get("status")){case l.MAGICIAN_PLAYING:t.start();break;case l.MAGICIAN_SCORE:t.score();break;case l.MAGICIAN_FINISHED:t.finish()}b.show()}function a(e){v.timing("final",e.end)}function c(){window.location="/score"}e("jquery"),e("velocity");var u=e("underscore"),l=e("js/constant"),f=e("backbone"),p=e("js/timer"),h=e("js/token"),d=e("socket-io");n.prototype.ensureAccuracy=function(){var e=this.selection.get("accuracy")||0,t=40+e/18*60+"%";this.$el.find(".frontend").hide().css("height",t).show(),this.$accuracy.html((e/18*100).toFixed(1)+"%")},n.prototype.showMagician=function(){this.$avatar.hide().attr("src",this.magician.get("avatar")).velocity("fadeIn"),this.$name.html(this.magician.get("name"))};var g=function(e,t){this.selection=t,this.el=e,this.$el=$(e),this.$cards=this.$el.find(".card"),_.on("magician-switched",u.bind(function(){var e=this.magician;this.magician=_.get("magician"),this.magician.once("start",u.bind(function(){e&&this.$cards.attr("class","card close")},this)),this.magician.once("scored",u.bind(function(){var e=this.magician.get("scores");u.each(e,u.bind(function(e,t){var n=this.$el.find(".judge:eq("+t+")");e=l.score(e);var r="card "+e,i=this.selection.get(String(this.magician.id));i===e&&(r+=" bingo highlighted"),console.log("showScore, className:",r),n.find(".card")[0].className=r},this))},this))},this))},m=f.Model.extend({score:function(e,t){this.set(String(e),t)},findScore:function(e){return u.find(this.keys(),u.bind(function(t){return"accuracy"!==t&&this.get(t)===e},this))}});o.prototype.ensureCards=function(){this.$cards.removeClass("highlighted").removeClass("selected"),[l.scores.ACE,l.scores.THREE,l.scores.FIVE,l.scores.SEVEN,l.scores.NINE,l.scores.JACK,l.scores.KING].forEach(u.bind(function(e){e=l.score(e);var t=this.cardSelection.findScore(e);t&&(this.magician&&this.magician.get("id")==t&&this.magician.get("status")!==l.MAGICIAN_WAITING?this.$el.find("."+e).removeClass("close").addClass("highlighted").addClass("selected"):this.$el.find("."+e).removeClass("highlighted").removeClass("selected").addClass("close"))},this))},o.prototype.clearHighlight=function(){this.$cards.removeClass("highlighted")};var y,v,b,w,x,k,S=f.Model.extend({setMagician:function(e){this.set("magician",e),this.trigger("magician-switched")}}),C=f.Model.extend({initialize:function(e){this.set(e)},isPlaying:function(){return this.get("status")===l.MAGICIAN_PLAYING},isScoring:function(){return this.get("status")===l.MAGICIAN_SCORE},start:function(){this.set("status",l.MAGICIAN_PLAYING),this.trigger("start")},score:function(){this.set("status",l.MAGICIAN_SCORE),this.trigger("score")},finish:function(){this.set("status",l.MAGICIAN_FINISHED),this.trigger("scored")}}),T="waiting",A="playing",E="score",N="finished",P=[],j=window.location.hostname,_=new S,B=new m;$(function(){b=$("#show"),v=new p($(".timer")[0]),v.setShowModel(_),w=new o($(".cards-wrapper")[0],B),x=new g($(".judge-list")[0],B),k=new n($(".magician")[0],B);var e=!1;y=d.connect("http://"+j+"/show"),y.on("connect",function(){function n(e){var t=(new Date).getTime();y.emit("query",{data:"status",id:t}),r[String(t)]=e}if(e)return void console.error("Connect event is duplicated!");e=!0,console.log("socket connected");var r={};y.on("query",function(e){var t=r[String(e.id)];console.log("query callback",e.id,t),t&&(delete r[String(e.id)],t.call(null,e.result))}),n(function(e){switch(e.status){case T:window.location="/wait";break;case A:s(e);break;case E:a(e);break;case N:default:c()}}),y.on("score",t(function(e){console.log("score"),a(e)})),y.on("magician-changed",t(function(e){console.log("magician changed---------------");var t=_.get("magician");t&&P.push(t),console.log(e),_.setMagician(new C(e)),console.log("---------------magician changed")})),y.on("magician-start",t(function(e){console.log("magician start---------------"),console.log(e),_.get("magician").set(e),_.get("magician").start(),console.log("---------------magician start")})),y.on("magician-score",t(function(e){console.log(e),console.log("magician score---------------");try{console.log(_);var t=_.get("magician");t&&(t.set(e),t.score())}catch(n){console.error(n)}console.log("---------------magician score")})),y.on("magician-finish",t(function(e){console.log("magician finish-------------"),console.log(e),_.get("magician").set(e),_.get("magician").finish(),console.log("-------------magician finish")})),y.on("finish",t(function(){console.log("The show is finished"),c()}))}),y.on("connect_error",function(e){console.error(e)}),y.on("connect_timeout",function(){console.error("connect timeout!")})})});