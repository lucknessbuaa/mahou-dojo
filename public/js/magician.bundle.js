...
S.mixin=function(e){C(S.functions(e),function(t){var n=S[t]=e[t];S.prototype[t]=function(){var e=[this._wrapped];return s.apply(e,arguments),I.call(this,n.apply(S,e))}})};// Generate a unique integer id (unique within the entire client session).
...
var I=function(e){return this._chain?S(e).chain():e};// Add all of the Underscore functions to the wrapper object.
S.mixin(S),// Add all mutator Array functions to the wrapper.
C(["pop","push","reverse","shift","sort","splice","unshift"],function(e){var t=r[e];S.prototype[e]=function(){var n=this._wrapped;return t.apply(n,arguments),"shift"!=e&&"splice"!=e||0!==n.length||delete n[0],I.call(this,n)}}),// Add all accessor Array functions to the wrapper.
C(["concat","join","slice"],function(e){var t=r[e];S.prototype[e]=function(){return I.call(this,t.apply(this._wrapped,arguments))}}),S.extend(S.prototype,{// Start chaining a wrapped Underscore object.
